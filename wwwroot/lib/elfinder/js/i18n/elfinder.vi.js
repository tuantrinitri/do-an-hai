...
(function(root, factory) {
  ...
  elFinder.prototype.i18.vi = {
    ...
    messages : {
        ...
        'confirmRm'       : 'Bạn có chắc chắn muốn xóa đối tượng?<br/>Dữ liệu sẽ không thể khôi phục!',
        'confirmRepl'     : 'Replace old file with new one?',
        'apllyAll'        : 'Apply to all',
        'name'            : 'Name',
        'size'            : 'Dung lượng',
        'perms'           : 'Permissions',
        'modify'          : 'Cập nhật gần nhất',
        'kind'            : 'Kiểu',
        'read'            : 'đọc',
        'write'           : 'ghi',
        ...
        'selectffile'     : 'Chọn tệp đầu tiên',
        'selectlfile'     : 'Chọn tệp cuối',
        'viewlist'        : 'Xem dạng danh sách',
        'viewicons'       : 'Xem dạng lưới',
        'places'          : 'Places',
        'calc'            : 'Calculate', 
        'path'            : 'Path',
        'aliasfor'        : 'Alias for',
