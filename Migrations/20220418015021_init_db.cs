        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitNameEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LogoHeader = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LogoFooter = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    EmbedMapURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScriptChatBot = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScriptGoogleTag = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoPosts = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RightWidgets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Slug = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SlugType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NoPosts = table.Column<int>(type: "int", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false),
                    Published = table.Column<bool>(type: "bit", nullable: false),
                    IsPreview = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomepageItems_HomepageBlocks_BlockId",
                        column: x => x.BlockId,
                        principalTable: "HomepageBlocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InfoSource = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvatarCaption = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvatarAltText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ApprovalById = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JoinPostCategories", x => new { x.PostId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_JoinPostCategories_PostCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "PostCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JoinPostCategories_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomepageItems_BlockId",
                table: "HomepageItems",
                column: "BlockId");

            migrationBuilder.CreateIndex(
                name: "IX_JoinPostCategories_CategoryId",
                table: "JoinPostCategories",
                column: "CategoryId");
